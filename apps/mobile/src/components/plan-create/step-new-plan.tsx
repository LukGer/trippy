...
import { AnimatedTripNamePlaceholder } from "@/src/components/plan-create/animated-trip-name-placeholder";
					...
					>
						{(field) => (
							<>
								<LabeledSingleLineField
									label="Trip name"
									placeholderNode={<AnimatedTripNamePlaceholder />}
					...
					<form.Field name="notes">
						{(field) => (
							<View>
								...
								<TextInput
									multiline
									className="type-body min-h-[200px] rounded-2xl bg-surface-card px-4 font-serif text-ink-primary"
